...
public record class PrintIntFuncSymbol(ITypeFactory Factory) : NativeFuncSymbol
{
    public override string Name => "Print";
    public override ITypeSymbol? DefiningType => null;
    public override ParameterInfo[] Parameters => [new("value", Factory.Int32, false, null)];
