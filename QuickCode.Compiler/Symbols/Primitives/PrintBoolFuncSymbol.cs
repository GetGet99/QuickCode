...
public record class PrintBoolFuncSymbol(ITypeFactory Factory) : NativeFuncSymbol
{
    public override string Name => "Print";
    public override ITypeSymbol? DefiningType => null;
    public override ParameterInfo[] Parameters => [new("value", Factory.Boolean, false, null)];
